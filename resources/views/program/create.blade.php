            ...
            <div class="form-group">
              ...
              <div class="form-group">
                ...
                <select name="edulevel_id" id="edulevel_id" class="form-control @error('edulevel_id') is-invalid @enderror">
                  ...
                  <option value="{{$item->id}}" {{ old('edulevel_id') == $item->id ? 'selected' : null}}>{{$item->name}}</option> <!--Selected adalah atribut html-->
                  @endforeach
              ...
              <div class="form-group">
                ...
                <input type="number" name="student_price" id="student_price" class="form-control @error('student_price') is-invalid @enderror" value="{{old('student_price')}}"><!--old() buat agar data tidak terhapus ketika alert berjalan-->
                @error('student_price')
                <div class="invalid-feedback">{{ $message }}</div>
                @enderror
              </div>
              <div class="form-group">
                ...
                <input type="number" name="student_max" id="student_max" class="form-control @error('student_max') is-invalid @enderror" value="{{old('student_max')}}"><!--old() buat agar data tidak terhapus ketika alert berjalan-->
                @error('student_max')
                <div class="invalid-feedback">{{ $message }}</div>
                @enderror
              </div>
              ...
              <div class="form-group">
                ...
                <textarea name="info" id="info" class="form-control @error('info') is-invalid @enderror">{{old('info')}}</textarea>
                @error('info')
                <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
